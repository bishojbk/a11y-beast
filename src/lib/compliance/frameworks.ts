...
export const FRAMEWORKS: FrameworkWithTags[] = [
  // USA
  {
    ...
    penalties: "DOJ enforcement, lawsuits, injunctive relief",
    url: "https://www.ada.gov/law-and-regs/title-ii-2024/",
    deadlineAlert: "ADA Title II deadline: April 24, 2026",
  ...
  },
  {
    ...
    appliesTo: "public",
    penalties: "Federal procurement disqualification",
  ...
  // Europe
  {
    ...
    penalties: "Member-state dependent. Up to 4% revenue.",
