 ...
 *  `branding.preparedBy` (Agency white-label) adds a "Prepared by" line and
 *  footer attribution — the engine credit stays, honestly. */
export function renderEvidenceHtml(
  r: EvidenceRecord,
  diff?: EvidenceDiff,
  branding?: { preparedBy?: string }
): string {
...
${branding?.preparedBy ? `<p class="meta"><strong>Prepared by:</strong> ${esc(branding.preparedBy)}</p>` : ""}
...
<footer>
${branding?.preparedBy ? `Prepared by ${esc(branding.preparedBy)} · engine: A11y Beast.` : "Generated by A11y Beast."} This document is a self-assessment aid, not legal advice or a certified audit.
</footer>
</body>
</html>`;
