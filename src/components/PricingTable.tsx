...
const TIERS: Tier[] = [
  {
    ...
    cta: { kind: "link", label: "Start scanning", href: "/" },
  },
  {
    name: "Pro",
    monthly: 39,
    tagline: "For teams shipping continuously who need to see risk across the whole site.",
    features: [
      "Everything in Free",
      "Multi-page site crawls",
      "Per-jurisdiction legal report export",
      "AI fix suggestions",
