        ...
        <p style={{ fontSize: 12, color: "var(--text-tertiary)", marginTop: 12, lineHeight: 1.55 }}>
          {isEaa ? (
            ...
            <>
              ...
              <a href="https://www.w3.org/WAI/planning/statements/" style={{ color: "var(--accent-text)", textDecoration: "underline", textDecorationColor: "var(--accent-line)", textUnderlineOffset: 2 }}>W3C/WAI</a>{" "}
